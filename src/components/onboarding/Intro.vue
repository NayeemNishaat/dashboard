    ...
    <div class="row">
      <div class="col-12">
        <div class="intro-panel mx-auto">
          <intro-panel
            v-if="step === 0"
            :title="$t('personalized homepages are the future')"
            :firstPanel="true"
          ...
          <intro-panel
            v-if="step === 1"
            :title="$t('first time visitors see best sellers')"
            nextBtnCaption="continue"
            @next="next"
            @back="back"
            @skip="exit"
          ...
          <intro-panel
            v-if="step === 2"
            :title="$t('each click instantly updates predictions')"
            nextBtnCaption="continue"
            @next="next"
            @back="back"
            @skip="exit"
          ...
          <intro-panel
            v-if="step === 5"
            :title="$t('relax, results will keep improving')"
            nextBtnCaption="store setup"
            :lastPanel="true"
            @next="next"
            @back="back"
            @skip="exit"
