export default {
  error: {
    ...
    login: {
      ...
      "lock.mfa_invalid_code":
        "Código incorrecto. Por favor vuelva a intentarlo.",
      session_missing:
    ...
    signUp: {
      ...
      password_no_user_info_error:
        "La constraseña es similar a los datos del usuario.",
  ...
  success: {
    ...
    forgotPassword:
      "Hemos enviado un correo para completar el restablecimiento de su contraseña.",
  ...
  enterpriseActiveLoginInstructions:
    "Ingrese las credenciales corporativas de %s.",
  failedLabel: "Error!",
  forgotPasswordTitle: "Restablecer contraseña",
  forgotPasswordAction: "¿Olvidó / Cambia su contraseña?",
  ...
  passwordStrength: {
    containsAtLeast:
      "Contener al menos %d de los siguientes %d tipos de caracteres:",
    identicalChars:
      'No más de %d caracteres idénticos juntos (ej., "%s" no está permitido)',
  ...
  passwordlessEmailCodeInstructions:
    "Se ha enviado un correo con el código a %s.",
  passwordlessEmailInstructions:
    "Ingrese su email para iniciar sesión<br/>o registrarse",
  passwordlessSMSAlternativeInstructions:
    "También puede ingresar su teléfono<br/>para iniciar sesión o registrarse",
  passwordlessSMSCodeInstructions:
    "Se ha enviado un SMS con el código<br/>a %s.",
  passwordlessSMSInstructions:
    "Ingrese su teléfono para iniciar sesión<br/>o registrarse",
  ...
  submitLabel: "Enviar",
  unrecoverableError:
    "Ocurrió un error.<br />Por favor, contacte a nuestro soporte técnico.",
  ...
  windowsAuthInstructions:
    "Usted se encuentra conectado desde su red corporativa&hellip;",
