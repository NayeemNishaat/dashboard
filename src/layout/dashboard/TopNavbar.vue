      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            <drop-down class="nav-item" title title-classes="nav-link" icon="ti-bell">
              <a class="dropdown-item">{{ $t("no notifications") }}</a>
            </drop-down>
            <li class="nav-item">
              <a :href="guideLink" class="nav-link" target="_blank" data-id="navbar:help-btn">
                <i class="ti-help"></i>
                <p>
                  {{ $t("help") }}
                </p>
            ...
            <li class="nav-item">
              <router-link to="/billing" class="nav-link" data-id="navbar:billing-btn">
            ...
            <drop-down class="nav-item" :title="userName" title-classes="nav-link" icon="ti-user"
              data-id="navbar:menu-btn">
              <a data-id="navbar:logout-btn" class="dropdown-item" @click="logout()">{{ $t("logout") }}</a>
            </drop-down>
          </ul>
        </div>
      </div>
